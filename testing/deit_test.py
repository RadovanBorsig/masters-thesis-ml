...
model = timm.create_model('deit3_base_patch16_224', pretrained=False, num_classes=4,
...
fig.text(0.5, 1.01, f"DeiT  ·  Testovacia úspešnosť: {test_acc:.2f}%", ha='center', fontsize=11, fontweight='bold', color='#1a1a1a', fontfamily='monospace')

plt.tight_layout()
plt.savefig("deit_confusion_matrix.png", dpi=300, bbox_inches='tight', pad_inches=0.3)
plt.show()
...
plt.tight_layout()
plt.savefig("deit_roc_curve.png", dpi=300, bbox_inches='tight', pad_inches=0.3)
plt.show()
