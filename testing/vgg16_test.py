...
model.classifier[6] = nn.Sequential(nn.Dropout(0.5), nn.Linear(num_features, 4))
...
fig.text(0.5, 1.01, f"VGG-16  ·  Testovacia úspešnosť: {test_acc:.2f}%",  ha='center', fontsize=11, fontweight='bold', color='#1a1a1a', fontfamily='monospace')

plt.tight_layout()
plt.savefig("vgg16_confusion_matrix.png", dpi=300, bbox_inches='tight', pad_inches=0.3)
plt.show()
...
plt.tight_layout()
plt.savefig("vgg16_roc_curve.png", dpi=300, bbox_inches='tight', pad_inches=0.3)
plt.show()
