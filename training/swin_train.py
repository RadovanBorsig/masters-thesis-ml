...
model = timm.create_model('swinv2_base_window12to16_192to256.ms_in22k_ft_in1k', pretrained=True, num_classes=4)
...
torch.save(model.state_dict(), f"training/models/swin_{EXP_NAME}.pth")
print(f"Final model saved as swin_{EXP_NAME}.pth")
...
plt.tight_layout()
plt.savefig(f"swin_progress_{EXP_NAME}.png", dpi=300, bbox_inches='tight')
plt.show()
