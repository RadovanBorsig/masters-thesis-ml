...
torch.save(model.state_dict(), f"training/models/efficientnet_{EXP_NAME}.pth")
print(f"Final model saved as efficientnet_{EXP_NAME}.pth")
...
plt.tight_layout()
plt.savefig(f"efficientnet_progress_{EXP_NAME}.png", dpi=300, bbox_inches='tight')
plt.show()
