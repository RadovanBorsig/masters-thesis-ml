...
torch.save(model.state_dict(), f"training/models/inceptionv3_{EXP_NAME}.pth")
print(f"Final model saved as inceptionv3_{EXP_NAME}.pth")
...
plt.tight_layout()
plt.savefig(f"inceptionv3_progress_{EXP_NAME}.png", dpi=300, bbox_inches='tight')
plt.show()
