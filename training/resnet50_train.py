...
torch.save(model.state_dict(), f"training/models/resnet50_{EXP_NAME}.pth")
print(f"Final model saved as resnet50_{EXP_NAME}.pth")
...
plt.tight_layout()
plt.savefig(f"resnet50_progress_{EXP_NAME}.png", dpi=300, bbox_inches='tight')
plt.show()
